...
public class BikeControl : MonoBehaviour
{
    ...
    void Update()
    {
        if(nitro==true)
        {
            //   speed = Mathf.Lerp(speed, speed + 30, 1f);
           // accelFwd = 5;
            Debug.LogError("nitro");
        }
        else
        {
          //  accelFwd = 0;
    ...
    void FixedUpdate()
    {
        ...
        foreach (WheelComponent w in wheels)
        {
            ...
            if (shift && (currentGear > 0 && speed > 30.0f) && shifmotor)
            {
                shifting = true;
    ...
    public void Nitrooo(int n)
    {
        if (speed > 30.0f && powerShift>1)
        {

            accelFwd = n;
            Debug.LogError("nitro run accelaration");
        }
        //else if(powerShift <= 1)
        //{
        //    accelFwd = 0;
        //    Debug.LogError("nitro run Dccelaration");
        //}
