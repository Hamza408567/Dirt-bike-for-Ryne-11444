...
public class GoogleMobileAdsDemoScript : MonoBehaviour
{
    ...
    public static bool destroyBanner;
    ...
    [SerializeField] private string rewardAndroid;
    [SerializeField] private string rewardIOS;
    ...
    {
#if UNITY_ANDROID
        string appId = appIdAndroid; //ca-app-pub-3940256099942544~3347511713 ca-app-pub-9925673017535105~1786785586
    ...
    private AdRequest CreateAdRequest()
    {
        return new AdRequest.Builder()
            ...
            //.AddTestDevice("33BE2250B43518CCDA7DE426D04EE231") //5BF5F61249BD0C8F 33BE2250B43518CCDA7DE426D04EE231 0123456789ABCDEF0123456789ABCDEF
            .AddKeyword("Ring Stack : ")
...
#if UNITY_ANDROID
        string adUnitId = bannerAndroid;  //	ca-app-pub-3940256099942544/6300978111 ca-app-pub-9925673017535105/6517719150
#elif UNITY_IPHONE
...
#if UNITY_ANDROID
        string adUnitId = interstitialAndroid; //	ca-app-pub-3940256099942544/1033173712  ca-app-pub-9925673017535105/2629093969
#elif UNITY_IPHONE
...
#if UNITY_ANDROID
        string adUnitId = rewardAndroid; //ca-app-pub-3940256099942544/5224354917 ca-app-pub-9925673017535105/7180489164
#elif UNITY_IPHONE
